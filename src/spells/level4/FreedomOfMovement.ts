...
const FreedomOfMovement = simpleSpell<HasTarget>({
  ...
  async apply(g, caster, method, { target }) {
    /* TODO You touch a willing creature. For the duration, the target's movement is unaffected by difficult terrain, and spells and other magical effects can neither reduce the target's speed nor cause the target to be paralyzed or restrained.
